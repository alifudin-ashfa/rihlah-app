  ...
  return (
    <div className="space-y-4 sm:space-y-6">
          ...
          <div className="w-full rounded-3xl bg-white p-4 text-slate-900 shadow-xl sm:p-5 xl:sticky xl:top-28">
            ...
            <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <NavLink to="/santri" className={buttonPrimary}>
                <Users className="mr-2 h-4 w-4" /> Catat Iuran
              </NavLink>
              <NavLink to="/vendor" className={buttonOutline}>
                <Wallet className="mr-2 h-4 w-4" /> Kelola Vendor
              </NavLink>
            </div>
          </div>
        </div>
        ...
        <Section title="Aksi cepat" subtitle="Buka halaman yang paling sering dipakai tanpa mencari menu lain.">
          <div className="grid gap-3 lg:grid-cols-2">
            <NavLink to="/santri" className="rounded-2xl border border-slate-200 bg-slate-50 p-4 transition hover:bg-slate-100">
              <p className="text-sm font-semibold text-slate-900">Tambah santri / iuran</p>
              <p className="mt-1 text-sm text-slate-500">Lengkapi biodata, cari santri, dan catat pembayaran.</p>
            </NavLink>
            <NavLink to="/vendor" className="rounded-2xl border border-slate-200 bg-slate-50 p-4 transition hover:bg-slate-100">
              <p className="text-sm font-semibold text-slate-900">Tambah tagihan vendor</p>
              <p className="mt-1 text-sm text-slate-500">Masukkan anggaran, DP, pelunasan, dan bukti transfer.</p>
            </NavLink>
            <NavLink to="/kegiatan" className="rounded-2xl border border-slate-200 bg-slate-50 p-4 transition hover:bg-slate-100">
              <p className="text-sm font-semibold text-slate-900">Atur kegiatan</p>
              <p className="mt-1 text-sm text-slate-500">Perbarui iuran default, rekening tujuan, dan pemasukan lain.</p>
            </NavLink>
      ...
      <div className="space-y-4 2xl:space-y-6">
        ...
        <Section title="Utilitas sistem" subtitle="Simpan cadangan data dan kelola file laporan.">
          <div className="space-y-3">
