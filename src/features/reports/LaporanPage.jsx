  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-wrap gap-2">
        ...
        {canEdit ? <button onClick={() => setLaporanView("audit")} className={tabClass(laporanView === "audit")}>Audit data</button> : null}
      </div>
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-2xl border bg-slate-50 p-4">
                {canEdit ? (
                  ...
                  <InlineBanner title="Mode pelihat" text="Export, backup, dan import hanya tersedia untuk admin/bendahara." tone="sky" />
                )}
                <p className="mt-3 text-sm text-slate-500">{canEdit ? "Gunakan ekspor saat perlu rekap rapat, dan gunakan backup sebelum melakukan perubahan besar." : "Anda tetap bisa membaca laporan dan audit tanpa login."}</p>
              </div>
              <div className="rounded-2xl border bg-slate-50 p-4">
